...
"$RepoRoot\Pokermon v3.1.0b\Saves\3\" `
-Recurse `
-Force
...
if (Test-Path "$RepoRoot\Pokermon v3.1.0b\GameFiles\version.dll")
{
    Copy-Item `
    "$RepoRoot\Pokermon v3.1.0b\GameFiles\version.dll" `
    "$SteamBalatro\version.dll" `
    -Force
}
...
Copy-Item `
"$RepoRoot\Pokermon v3.1.0b\Mods" `
"$env:APPDATA\Balatro\Mods" `
-Recurse
