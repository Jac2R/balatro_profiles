...
function Game:start_run(args)
    ...
    if not saveTable then
        ...
        if args.challenge and args.challenge.rules and args.challenge.rules.custom and next(args.challenge.rules.custom) and args.challenge.rules.custom[1].id == "poke_mystery_dungeon" then
